...
namespace Bimbel_2
{
    public partial class RegistrasiAnggotaBimbel : Form
    {
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            {
                cmd = new SqlCommand("Insert into Pendaftaran(id_siswa,id_paket,id_kelas,id_jenis_angsuran,id_sesi,tgl_registrasi,tipe_bayar,diskon,total_bayar)values(@siswa,@paket,@kelas,@jenis,@sesi,@regis,@tipe,@diskon,@total)", con);
